...
function DynamicNavbar(param) {
    ...
    const handleLogout = (e)=>{
        e.preventDefault();
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$slices$2f$authSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logout"])()); // Dispatch the sync action
        router.push('/login');
    };
    if (!userRole) {
        return null;
...
_s(DynamicNavbar, "cEwdbmarrbNpvXTl5rL3be2GMX8=", false, function() {
    return [
...
//# sourceMappingURL=_332c1b6a._.js.map